...
struct ModuleCardsSection: View {
    ...
    @Binding var showingMoviesView: Bool
    ...
    var body: some View {
        LazyVGrid(columns: [
            ...
            ForEach(Array(modules.enumerated()), id: \.element.type.id) { index, module in
                VibrantModuleCard(module: module, index: index, showingShoppingView: $showingShoppingView, showingRecipesView: $showingRecipesView, showingMoviesView: $showingMoviesView)
            }
        }
...
#Preview {
    ...
    @State var showingMoviesView = false
    let sampleModules = [
        ...
        ModuleData(type: .movies, itemCount: 12, recentActivity: "Wishlist updated", progress: 0.0),
    ...
    NavigationView {
        ScrollView {
            ModuleCardsSection(modules: sampleModules, showingShoppingView: $showingShoppingView, showingRecipesView: $showingRecipesView, showingMoviesView: $showingMoviesView)
        }
